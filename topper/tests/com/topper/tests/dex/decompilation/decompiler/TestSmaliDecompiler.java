...
public class TestSmaliDecompiler {
	...
	private static final Opcodes opcodes = Opcodes.forDexVersion(ConfigManager.getInstance().getConfig().getDexVersion());
	...
	public void Given_EmptyBytecode_When_Decompiling_Expect_EmptyInstructionList() {
		...
		final DecompilationResult result = decompiler.decompile(new byte[0], null, opcodes);
	...
	public void Given_InvalidInstruction_When_Decompiling_Expect_ExceptionWithContext() {
		...
		final Decompiler decompiler = new SmaliDecompiler();
		assertThrowsExactly(ExceptionWithContext.class, () -> decompiler.decompile(INVALID_INSTRUCTION_BYTECODE, null, opcodes));
	}
}