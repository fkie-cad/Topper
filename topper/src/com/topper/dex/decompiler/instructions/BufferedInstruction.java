...
public class BufferedInstruction implements Instruction {
    ...
    public static BufferedInstruction readFrom(final DexReader<?> reader) {
        ...
        BufferedInstruction instruction = buildInstruction(reader.dexBuf, opcode, reader.getOffset());
        reader.moveRelative(instruction.getCodeUnits()*2);
        return instruction;
    }
    
    private static BufferedInstruction buildInstruction(final DexBuffer buffer, Opcode opcode, int instructionStartOffset) {
    	...
    	switch (opcode.format) {
	    	...
	    	case Format20bc:
	    		return new BufferedInstruction20bc(buffer, opcode, instructionStartOffset);
	    	case Format20t:
	    		return new BufferedInstruction20t(buffer, opcode, instructionStartOffset);
	    	case Format21c:
	    		return new BufferedInstruction21c(buffer, opcode, instructionStartOffset);
	    	case Format21ih:
	    	...
	    	case Format22c:
	    		return new BufferedInstruction22c(buffer, opcode, instructionStartOffset);
	    	case Format22cs:
	    	...
	    	case Format31c:
	    		return new BufferedInstruction31c(buffer, opcode, instructionStartOffset);
	    	case Format31i:
	    	...
	    	case Format35c:
	    		return new BufferedInstruction35c(buffer, opcode, instructionStartOffset);
	    	case Format35ms:
	    	...
	    	case Format3rc:
	    		return new BufferedInstruction3rc(buffer, opcode, instructionStartOffset);
	    	case Format3rmi:
	    	...
	    	case Format45cc:
	    		return new BufferedInstruction45cc(buffer, opcode, instructionStartOffset);
	    	case Format4rcc:
	    		return new BufferedInstruction4rcc(buffer, opcode, instructionStartOffset);
	    	case Format51l:
